...
export default {
    ...
    methods: {
        populateData() {
            ...
            this.items.push({name: 'Gas', key: "kWh", color: this.gas_value[2], icon: this.gas_value[3]})
    ...
    computed: {
        ...
        ...mapGetters({electricity: 'getElectricity'}),
        ...mapGetters({gas: 'getGas'}),
        ...mapGetters({water: 'getWater'}),
        ...mapGetters({co: 'getCo'})
    },
    mounted() {
        this.populateData()
