  ...
  <v-card flat class="mb-7">
    <v-card-text class="pa-5 success">
      <div class="d-flex align-center">
        ...
        <div class="mr-4">
          <h3 class="card-title white--text title font-weight-regular">Gas Usage</h3>
          <h6 class="card-subtitle white--text op-5 subtitle-2 font-weight-regular">{{ timeline.date }}</h6>
        </div>
      </div>
      <v-row class="mt-2">
        <v-col cols="4" class="d-flex align-center">
          <h2 class="font-weight-light white--text text-nowrap">{{Math.round(building_data.annual_non_electrical)}} kWh</h2>
        </v-col>
        <v-col cols="8">
...
<script src='./BarMetrics.js' />
<style scoped lang="scss" src="./BarMetrics.scss"></style>