                              ...
                              <v-col cols="12" sm="6" lg="3" class="py-0">
                                <v-card height="150">
                                  <v-card-text>
                                    <v-row class="d-flex align-center">
                                      <v-col cols="6">
                                        <h2 class="font-weight-light headline">Main Fuel</h2>
                                        <h5
                                          class="subtitle-2 text-no-wrap blue-grey--text text--lighten-2 font-weight-regular"
                                        > {{ transaction.Value.attributes.main_fuel }}</h5>
                                      </v-col>
                                    </v-row>
                                  </v-card-text>
                                </v-card>
                              ...
                              <v-col cols="12" sm="6" lg="3" class="py-0">
                                <v-card height="150">
                                  <v-card-text>
                                    <v-row class="d-flex align-center">
                                      <v-col cols="6">
                                        <h2 class="font-weight-light headline">Environment</h2>
                                        <h5
                                          class="subtitle-2 text-no-wrap blue-grey--text text--lighten-2 font-weight-regular"
                                        >  {{ transaction.Value.attributes.environment  }}</h5>
                                      </v-col>
                                    </v-row>
                                  </v-card-text>
                                </v-card>
