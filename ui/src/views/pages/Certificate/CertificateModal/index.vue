  ...
  <v-card>
    <v-row class="pa-4">
        <v-col cols="12" sm="12" lg="4">
            <v-card color="#c5ccd4">
                <v-card-text>
                    ...
                    >    
                        <li v-if="i < 3">
                           <p> <strong> {{keys[i]}}</strong> <br/> {{data[i]}} </p>
                        </li>
                    </ul>
                </v-card-text>
            </v-card>
        ...
        <v-col cols="12" sm="12" lg="12" class="py-0">
            <v-card color="#c5ccd4" class="text-center mb-7">
    ...
    <div>
      <v-row>
        ...
        <v-col cols="12" sm="6" lg="2">
          <v-card dark class="mb-2 pa-4" min-width="100">
            Carbon Dioxide (Co
            <sub>2</sub>) emissions indicator
          </v-card>
          <v-card class="pa-4" min-width="100" color="#c5ccd4">
            Annual Co
